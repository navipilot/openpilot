...
# tici lite: fcam + ecam only, no dcam (driver camera absent on this hardware variant)
_tici_lite_ar_config = DeviceCameraConfig(CameraConfig(1928, 1208, 2648.0), _NoneCameraConfig(), _ar_ox_fisheye)
_tici_lite_os_config = DeviceCameraConfig(CameraConfig(2688 // 2, 1520 // 2, 1522.0 * 3 / 4), _NoneCameraConfig(), _os_fisheye)
DEVICE_CAMERAS.update({
  ("tici lite", "ar0231"):  _tici_lite_ar_config,
  ("tici lite", "ox03c10"): _tici_lite_ar_config,
  ("tici lite", "os04c10"): _tici_lite_os_config,
  ("tici lite", "unknown"): _tici_lite_ar_config,
})
