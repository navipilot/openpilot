...
class HyundaiSettings(BrandSettings):
  def __init__(self):
    ...
    self.longitudinal_tuning_item = multiple_button_item(tr("Custom Longitudinal Tuning"), "", tuning_texts,
  ...
  def update_settings(self):
    ...
    if longitudinal_tuning_disabled:
      if not ui_state.is_offroad():
        ...
        long_tuning_desc = tr("This feature is unavailable because IQ.Pilot Longitudinal Control (Alpha) is not enabled.")
