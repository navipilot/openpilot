...
class SubaruSettings(BrandSettings):
  def __init__(self):
    ...
    self.stop_and_go_toggle = toggle_item(tr("Stop and Go (Beta)"), "", param="SubaruStopAndGo", callback=self._on_toggle_changed)

    self.stop_and_go_manual_parking_brake_toggle = toggle_item(tr("Stop and Go for Manual Parking Brake (Beta)"), "",
