...
class CircularAlertsRenderer:
  def __init__(self):
    self._green_light_alert_img = gui_app.texture("../../iqpilot/selfdrive/assets/images/green_light.png", 250, 250)
    self._lead_depart_alert_img = gui_app.texture("../../iqpilot/selfdrive/assets/images/lead_depart.png", 250, 250)
  ...
  def update(self) -> None:
    ...
    self._green_light_alert = lp_iq.e2eAlerts.greenLightAlert
    self._lead_depart_alert = lp_iq.e2eAlerts.leadDepartAlert
