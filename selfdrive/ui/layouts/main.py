...
if gui_app.iqpilot_ui():
  from openpilot.selfdrive.ui.iqpilot.layouts.settings.settings import IQSettingsLayout as SettingsLayout
...
class MainLayout(Widget):
  ...
  def _render_main_content(self):
    ...
    current_layout = self._layouts[self._current_mode]
    current_layout.render(content_rect)
