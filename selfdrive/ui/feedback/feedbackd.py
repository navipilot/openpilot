...
def main():
  ...
  sm = messaging.SubMaster(['rawAudioData', 'bookmarkButton', 'carState', 'iqState'])
  ...
  while True:
    ...
    # only allow the LKAS button to record feedback when AOL is disabled
    ss_ext = sm['iqState']
    if False and sm.updated['carState'] and sm['carState'].canValid and not ss_ext.aol.available:
