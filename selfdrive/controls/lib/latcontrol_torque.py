...
VOLT_STANDARD_TURN_IN_BOOST_LEFT = 0.12
VOLT_STANDARD_TURN_IN_BOOST_RIGHT = 0.40
VOLT_STANDARD_UNWIND_TAPER_LEFT = 0.18
VOLT_STANDARD_UNWIND_TAPER_RIGHT = 0.34
VOLT_STANDARD_FRICTION_MULT = 1.04
VOLT_STANDARD_FRICTION_LAT_RISE = 0.20
VOLT_STANDARD_FRICTION_JERK_RISE = 0.24
VOLT_STANDARD_TURN_IN_THRESHOLD_REDUCTION_LEFT = 0.06
VOLT_STANDARD_TURN_IN_THRESHOLD_REDUCTION_RIGHT = 0.22
VOLT_STANDARD_UNWIND_THRESHOLD_INCREASE_LEFT = 0.08
VOLT_STANDARD_UNWIND_THRESHOLD_INCREASE_RIGHT = 0.28
VOLT_STANDARD_TURN_IN_FRICTION_BOOST_LEFT = 0.03
VOLT_STANDARD_TURN_IN_FRICTION_BOOST_RIGHT = 0.12
VOLT_STANDARD_UNWIND_FRICTION_REDUCTION_LEFT = 0.08
VOLT_STANDARD_UNWIND_FRICTION_REDUCTION_RIGHT = 0.22
VOLT_STANDARD_CENTER_TAPER_MAX = 0.09
VOLT_STANDARD_CENTER_TAPER_LAT = 0.11
...
IONIQ_6_UNWIND_TAPER_LEFT = 0.68
IONIQ_6_UNWIND_TAPER_RIGHT = 1.30
...
IONIQ_6_UNWIND_THRESHOLD_INCREASE_LEFT = 0.48
IONIQ_6_UNWIND_THRESHOLD_INCREASE_RIGHT = 1.16
