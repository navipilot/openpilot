...
MAPD_HASH_PATH = os.path.join(BASEDIR, "iqpilot", "mapd", "tests", "mapd_hash")
MAPD_VERSION_PATH = os.path.join(BASEDIR, "iqpilot", "mapd", "mapd_installer.py")
...
if __name__ == "__main__":
  ...
  if not args.new_ver:
    ...
    print("Example:")
    print("  python iqpilot/mapd/update_version.py --new_ver \"v1.12.0\"")
